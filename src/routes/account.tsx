          ...
          <div className="mb-4 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Keep recommendations, watchlists and progress separate for everyone.
              </p>
            </div>
            <span className="shrink-0 text-xs font-semibold text-muted-foreground">Up to 4</span>
          </div>
          <ProfilesManager userId={user.id} />
        </section>
